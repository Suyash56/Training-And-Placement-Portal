    ...
    if request.method == 'POST':
        ...
        if user:
            if user.is_active:
                login(request,user)
                uname=user.username
                if uname[0]=='E' and uname[1]=='T' and uname[2]=='C':
                    return show(request)
                else:
            ...
            return HttpResponse('<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous"><br><br><br><div class="jumbotron" style="color:red"><h1>Invalid Credentials!<h1></div>')
    else:
